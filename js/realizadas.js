...
// ===== NUEVA FUNCIÓN DE LOADER INTELIGENTE =====
    ...
    // ===== Cargar citas realizadas de un día =====
    async function loadDoneAppointments(dayISO){
      ...
      if (!data || !data.length){
        apptList.innerHTML = '<div class="card empty">No hay citas realizadas para este día.</div>';
        return;
      }
    ...
    // Click día (marca seleccionado en color de marca y carga realizadas)
